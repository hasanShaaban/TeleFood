    ...
    return SliverToBoxAdapter(
      child: BlocConsumer<CartCubit, CartState>(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      'Delete',
                                      style:
                                          kMvBoli20.copyWith(color: Colors.red),
        ...
        listener: (BuildContext context, CartState state) {
          if(state is CartSuccess && state.response.data!.isEmpty){
